...
class Game(QWidget):
    ...
    def start(self):
        ...
        with open(f'data/saves/locations/loc_{self.choose}.csv', 'w', encoding="utf8") as csvfile:
        ...
        self.generate_random_cell()
        self.update_field(self.game_field_matrix)
    ...
    def move_back(self):
        if self.move_back_flag:
            ...
            self.update_field(self.game_field_matrix_last)
            ...
            for y in range(1, self.side_length):
                ...
                while True:
                    ...
                    if cell != 'None':
                        ...
                        if cell_up != cell and cell_up != 'None':
                            break
            ...
            for y in range(self.side_length - 2, -1, -1):
                ...
                while True:
                    ...
                    if cell != 'None':
                        ...
                        if cell_down != cell and cell_down != 'None':
                            break
        ...
        for x in range(1, self.side_length):
            for y in range(self.side_length):
                ...
                while True:
                    ...
                    if cell != 'None':
                        cell_down = self.game_field_matrix[y][cell_x - 1]
                        if cell_down != cell and cell_down != 'None':
                            break

                        elif cell_down == 'None':
                            self.game_field_matrix[y][cell_x - 1] = cell
                            self.game_field_matrix[y][cell_x] = cell_down
    ...
    def post_processing(self):
        ...
        if self.game_field_matrix != self.game_field_matrix_last:
            self.game_score_line_edit.setText(
                self._translate("Game", str(self.score)))
            self.check_record()
