...
class Main(QMainWindow):
    ...
    def setupUi(self, Main):
        ...
        Main.setWindowIcon(QtGui.QIcon('data/pictures/design/logo_2048.png'))
        ...
        self.title_image.setPixmap(
            QtGui.QPixmap("data/pictures/design/title.jpg"))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("data/pictures/buttons/play.png"),
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("data/pictures/buttons/records.png"),
                        QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("data/pictures/buttons/exit.png"),
                        QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.image_4x4.setPixmap(QtGui.QPixmap(
            "data/pictures/examples_of_fields/4x4.jpg"))
        ...
        self.image_5x5.setPixmap(QtGui.QPixmap(
            "data/pictures/examples_of_fields/5x5.jpg"))
        ...
        self.image_6x6.setPixmap(QtGui.QPixmap(
            "data/pictures/examples_of_fields/6x6.jpg"))
        ...
        self.image_8x8.setPixmap(QtGui.QPixmap(
            "data/pictures/examples_of_fields/8x8.jpg"))
